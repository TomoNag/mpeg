...
namespace FFmpegWrapper
{
    ...
    {
        public static WindowsFormsApplication1.Form1 form;

        public static unsafe void GetFrame(string url, double request_time)
        {
            ...
            long request_timestamp = (long)(request_time * FFmpegInvoke.AV_TIME_BASE / (*pStream).time_base.num);  //av_q2d(stream_time_base);
            FFmpegInvoke.avformat_seek_file(pFormatContext, stream_index, long.MinValue, request_timestamp, long.MaxValue, 0);

            //FFmpegInvoke.av_seek_frame(pFormatContext, stream_index, timestamp, 0);
        ...
        public static unsafe void My(string url)
        {
            Console.WriteLine("Runnung in {0}-bit mode.", Environment.Is64BitProcess ? "64" : "32");
